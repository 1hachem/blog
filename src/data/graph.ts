...
export const TECH = {
	...
	vnc: { label: 'VNC', bg: '#d7dde8', dark: false, icon: null },
	...
	tailwind: { label: 'Tailwind CSS', bg: '#06B6D4', dark: true, icon: 'devicon-tailwindcss-plain' },
	nextjs: { label: 'Next.js', bg: '#000000', dark: true, icon: 'devicon-nextjs-plain' },
	'tanstack-start': { label: 'TanStack Start', bg: '#F7443D', dark: true, icon: null },
	infisical: { label: 'Infisical', bg: '#000000', dark: true, icon: null },
	postgres: { label: 'Postgres', bg: '#336791', dark: true, icon: 'devicon-postgresql-plain' },
...
export const history: Commit[] = [
	...
	},
	{
		...
		year: '2022',
		type: 'side',
		title: 'Switched to Linux as my daily driver',
